...
public class PinkBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, ImplementedInventory {
    ...
    public PinkBlockEntity(BlockPos pos, BlockState state) {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0: PinkBlockEntity.this.progress = value;
                    case 1: PinkBlockEntity.this.maxProgress = value;
                }
            }
    ...
    protected void writeNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registryLookup) {
        ...
        nbt.putInt("pink.progress", progress);
        nbt.putInt("pink.max_progress", maxProgress);
    }

    @Override
    protected void readNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registryLookup) {
        Inventories.readNbt(nbt, inventory, registryLookup);
        progress = nbt.getInt("pink.progress");
        maxProgress = nbt.getInt("pink.max_progress");
