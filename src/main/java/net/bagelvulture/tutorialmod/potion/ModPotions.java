package net.bagelvulture.tutorialmod.potion;
...
public class ModPotions {
    public static final RegistryEntry<Potion> IMAPLANT_POTION = registerPotion("imaplant_potion",
            new Potion(new StatusEffectInstance(ModEffects.IMAPLANT, 1200, 0)));
