...
public class ModEnchantmentEffects {
    public static final MapCodec<? extends EnchantmentEntityEffect> LIGHTNING_STRIKER =
            registerEntityEffect("too_many_pigs", TooManyPigsEnchantmentEffect.CODEC);


    private static MapCodec<? extends EnchantmentEntityEffect> registerEntityEffect(String name, MapCodec<? extends
    ...
    public static void registerEnchantmentEffects() {
        TutorialMod.LOGGER.info("Registering " + TutorialMod.MOD_ID + "'s Enchantment Effects");
    }
}